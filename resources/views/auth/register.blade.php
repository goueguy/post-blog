        ...
        <div class="w-6/12 bg-white p-6 rounded-lg">
            <form action="{{route('register')}}" method="post">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="name" id="name" placeholder="Your name"  class="bg-gray-100 border-2 w-full  p-4 rounded-lg @error('email') border-red-500 @enderror" value="{{old('name')}}">
                    @error('name')
                 ...
                 <div class="mb-4">
                    ...
                    <input type="text" name="username" id="username" placeholder="Your username"  class="bg-gray-100 border-2 w-full  p-4 rounded-lg @error('username') border-red-500 @enderror" value="{{old('name')}}">
                    @error('username')
                        <div class="text-red-500 mt-2 text-sm">
                            {{$message}}
                        </div>
                ...
                <div>
                    <button type="submit" class="bg-green-500 text-white px-4 py-3 rounded-lg w-full">Register</button>
                </div>
            </form>
        </div>
    </div>
